...
import os
import torch
from exp.exp_long_term_forecasting_vlbm import Exp_Long_Term_Forecast_vlbm
from exp.exp_ood_forecasting_vlbm import Exp_Long_Term_Forecast_ood_vlbm
from exp.exp_ood_forecasting_vlbm_large import Exp_Long_Term_Forecast_ood_vlbm_large
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=False, default='VLBM',
                        help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, required=False, default='ETTm1', help='dataset type')
    parser.add_argument('--root_path', type=str, default='raw_files/ETT-small/', help='root path of the data file')
    ...
    parser.add_argument('--num_Period_Block', type=int, default=2)
    ...
    parser.add_argument('--enc_var',type=int,default=512)
    ...
    if args.task_name == 'long_term_forecast_vlbm':
        Exp = Exp_Long_Term_Forecast_vlbm
    elif args.task_name == 'ood_vlbm':
        Exp = Exp_Long_Term_Forecast_ood_vlbm
    elif args.task_name == 'ood_vlbm_large':
        Exp = Exp_Long_Term_Forecast_ood_vlbm_large
